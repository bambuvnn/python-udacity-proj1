...
FILTERS_DICT = {
    "date": lambda x: DateFilter.eq(x),
    "start_date": lambda x: DateFilter.ge(x),
    "end_date": lambda x: DateFilter.le(x),
    "distance_min": lambda x: DistanceFilter.ge(x),
    "distance_max": lambda x: DistanceFilter.le(x),
    "velocity_min": lambda x: VelocityFilter.ge(x),
    "velocity_max": lambda x: VelocityFilter.le(x),
    "diameter_min": lambda x: DiameterFilter.ge(x),
    "diameter_max": lambda x: DiameterFilter.le(x),
    "hazardous": lambda x: HazardousFilter.eq(x),
}


def create_filters(*args, **kwargs):
    ...
    for key, value in kwargs.items():
        if value is not None:
            filters.append(FILTERS_DICT[key](value))
